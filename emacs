...
;; path
(setenv "PATH" (concat "/Users/jfoutz/Library/Haskell/ghc-7.4.2/lib/cabal-install-1.20.0.3/bin/:" (getenv "PATH")))
(add-to-list 'exec-path "/Users/jfoutz/Library/Haskell/ghc-7.4.2/lib/cabal-install-1.20.0.3/bin/")
;; haskell stuff
